...
export const resetThePassword = (userEmail, password, retypepassword) => (dispatch) => {
    const url = RESET_PASSWORD; 

    const dataToSend = {email: userEmail, newpassword: password, cpassword: retypepassword};
    let formDetails = [];
