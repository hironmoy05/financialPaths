            ...
            <Card.Container balCardContainer={balCardContainer}>
                ...
                <Card.ButtonBox buttonPad={buttonPad}>
                    <Card.ActionButtonBox actionButtonBox={actionButtonBox}>
                        <Buy />
                        <Card.ActionButton onPress={() => navigation.navigate('BuyCoin')}><Card.ActionButtonText actionButtonText={actionButtonText}>Buy</Card.ActionButtonText></Card.ActionButton>
